...
@objc extension PlaceAtBrick: CBInstructionProtocol {
    ...
    @objc func actionBlock(_ formulaInterpreter: FormulaInterpreterProtocol) -> () -> Void {
        ...
        return {
            ...
            spriteNode.setCatrobatPosition(positionX: formulaInterpreter.interpretDouble(self.xPosition, for: object) as NSNumber,
                                           positionY: formulaInterpreter.interpretDouble(self.yPosition, for: object) as NSNumber)
        }
    }
}
